...
function readRoteiro() {
    $(document).ready(function () {
        getLine('roteiros/REV-5/pt-br/roteiro_full/titles.txt', step, line => {
            stepHistory.textContent = line;
        });
        $.get("roteiros/REV-5/pt-br/roteiro_full/step" + step + ".txt", function (data) {
...
function readSystem() {
    $(document).ready(function () {
        ...
        $.get("roteiros/REV-5/pt-br/system.txt", function (data) {
            $("#texto-container").text(data);
        });
    });
}
function readMecanicas(){
    $(document).ready(function () {
        ...
        $.get("roteiros/REV-5/pt-br/mecanicas.txt", function (data) {
            $("#texto-container").text(data);
        });
    });
}
function readInterfaces(){
    $(document).ready(function () {
        ...
        $.get("roteiros/REV-5/pt-br/interfaces.txt", function (data) {
            $("#texto-container").text(data);
        });
    });
}
function readRoteiroOld() {
    $(document).ready(function () {
        getLine('roteiros/REV-4/titles.txt', step, line => {
            stepHistory.textContent = line;
        });
        $.get("roteiros/REV-4/step" + step + ".txt", function (data) {
            $("#texto-container").text(data);
        });
    });
}
